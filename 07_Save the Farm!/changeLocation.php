<?php
  ...
  // From the kitchen, a player can enter the bathroom or go out to the woods

function changeLocation() {	

  // Access the global location
  global $location;

  // We need to know where the player wants to go
  echo "Where do you want to go?\n";
  $go_to = strtolower(readline(">> "));

  // Check their current location and proceed accordingly
